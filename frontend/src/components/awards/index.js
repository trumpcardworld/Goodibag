...
const award_data = [
  {
    id: "one",
    topic: "FREE SHIPPING",
    title: "Fast & Free Delivery Nationwide",
    data_src: award_img_1,
    subtitle: "Get your orders delivered at no extra cost",
    delay: ".3s",
  },
  {
    id: "two",
    topic: "FREE RETURN",
    title: "Easy Return upto 7 days",
    data_src: award_img_2,
    subtitle: "Hassle-free returns within a week of purchase",
    delay: ".5s",
  },
  {
    id: "three",
    ...
    subtitle: "Your transactions are protected with advanced encryption",
    delay: ".7s",
  },
  {
    id: "four",
    ...
    subtitle: "Only the finest materials and craftsmanship",
    delay: ".7s",
  },
];
...
const Awards = () => {
  return (
    <>
      <section className={`award__area pt-110 pb-120 pb-10 white-bg`}>
