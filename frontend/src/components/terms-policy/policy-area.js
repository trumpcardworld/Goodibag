          ...
          <div className="col-xl-10">
            <div className="policy__wrapper policy__translate p-relative z-index-1">
              <div className="policy__item mb-35">
                ...
                <p>
                  Goodibag knows that you care about how your personal information
                  is used and shared, and Goodibag takes your privacy seriously.
                  Please read the following to learn more about Goodibag Privacy
                ...
                <p>
                  ...
                  Goodibag will collect, use, and share your information in the
                  following ways. Remember that your use of Services is at all
                  times subject to the Terms as set forth at
                  https://goodibag.com/legal/terms, which incorporate this Privacy
                  Policy. Any terms Goodibag uses in this Privacy Policy without
              ...
              <div className="policy__contact">
                ...
                <ul>
                  <li>
                    Email:{" "}
                    <span>
                      <a href="mailto:goodibag.com">support@goodibag.com</a>
                    </span>
                  </li>
                </ul>
